    ...
    if (cokeScore > pepsiScore) {
      ...
      //}).then((result) => {
       ...
       // if (result.isConfirmed) {
        ...
        //}
      //})
      swal({ confirmButtonColor: '#CD853F', background:'#FF6B6B',    title: `Coca Cola!`, text: aree[areeIndex], imageUrl: "https://us.coca-cola.com/store/media/catalog/product/1/6/16181_squeeze-ko-can-maria-2.png?quality=80&fit=bounds&height=750&width=700&canvas=700:750", imageSize: "306x220", confirmButtonText: "Gotcha!", },    function(isConfirm) {
        if (isConfirm) {
        }});
    } else if (pepsiScore > cokeScore) {
      result= "You are Pepsi!";
      ...
      swal({ confirmButtonColor: '#CD853F', background:'#FF6B6B',    title: `Pepsi!`, text: arre[arreIndex], imageUrl: "https://www.pepsico.com/images/default-source/products-brands/pepsi_12oz.png?sfvrsn=46c9ae09_0", imageSize: "306x220", confirmButtonText: "Gotcha!", },    function(isConfirm) {
        if (isConfirm) {
        }});
    } else {
